...
h2{
    text-align: center;
        ...
        <body style="background-color:rgb(231, 231, 206);">
            ...
            <br>
            <br>
            <h1 style="text-align:center;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">Advertise with us</h1>
            <h3>We also have the policy of advertising other content on our webpage.The advertising company must fulfill some of the conditions in order to 
                advertise with us.Any act of indiscipline would lead to end of agreement for advertising and the company would not be allowed to advertise again with us.
                Advertisement related to India's culture and Rail tickets and other railway policy are greatly welcomed.There are certain norms which should be followed during promotions.
            </h3>
            <br>
            <h3>In case you feels that you want to advertise with us, contact our developers.</h3>
            <a href="contact.html" style="margin-left: 700px;;text-decoration:none;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">Contact Us</a>
