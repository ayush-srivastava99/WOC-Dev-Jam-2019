...
h2{
    ...
    margin-left: 50px;
        ...
        <body style="background-color:rgb(231, 231, 206);">
            ...
            <div style="width:100%,height: 50px;border:1px dotted green;margin-top:70px;background-color:rgb(144, 253, 144);">
                <h1 style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;font-weight: 400;text-align: center">Contact Us!</h1>
            </div>
            <br>
            <br>
            <h2>HelpLine</h2>
            ...
            <h3>+91 9123456789</h3>
            <br>
            <h2>Complaints! Write us at</h2>
            <h3>devnocturnals@gmail.com</h3>
            <br>
            <h2>Tollfree no.</h2>
            <h3>1800-56565</h3>
            <br><br><br><br>
