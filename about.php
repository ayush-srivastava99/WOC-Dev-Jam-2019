...
h2{
    text-align: center;
        ...
        <body style="background-color:rgb(231, 231, 206);">
            ...
            <br>
            <br>
            <h1 style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;font-weight:400;color:crimson;text-align:center;font-size:40px;">About Us</h1>
            <h2>About Developers</h2>
            <h3>The website is designed and developed by Team Nocturnals which is constituted by students of NIT Alllabad.</h3>
            <h3>The website was developed to provide an online platform to a startup by the students of NIT Allahabad.</h3>
            <h3>Ayush Srivastava and Nishant Kumar were the members of the team involved int the development of the website.</h3>
            <h3>The website was developed as a project under a event organised by final and pre-final years students of NIT Allahabad.</h3>  
            <br>
            <br>
